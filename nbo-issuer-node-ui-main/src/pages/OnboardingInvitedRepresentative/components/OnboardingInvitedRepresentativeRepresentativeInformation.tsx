...
const OnboardingInvitedRepresentativeRepresentativeInformation = () => {
  const {
    control,
    trigger,
    formState: { errors },
  ...
  const handleClickNext = async () => {
    ...
    if (isStepValid) {
      navigate(AppRoutes.ONBOARDS_REPRESENTATIVE_PREVIEW);
    }
  };

  const handleSetFormValue = (v: InferType<typeof schema>["personalDetails"]) =>
...
export default OnboardingInvitedRepresentativeRepresentativeInformation;
