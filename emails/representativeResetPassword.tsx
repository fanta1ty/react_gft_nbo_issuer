...
export default function RepresentativeResetPassword() {
  ...
  return (
    <Wrapper previewText="Instructions to reset your password">
      <Container className="w-full max-w-[632px] px-4 mb-20">
        ...
        <Paragraph className="mb-7">
          To ensure your account's security, we've initiated the password reset
          process. In the next {expireIn}, proceed to create your new password
          using the buton below
        </Paragraph>
